...
This is the same safe-harbor pattern used by the existing #71 eco kit, #74 agri kit, #75 DIY kit, and #77 seed kit in this repository. The kit is offered as documentation and deterministic firmware logic; the maintainer can tune the swath width, moisture thresholds, and weed height cutoffs for their specific grass and soil.
